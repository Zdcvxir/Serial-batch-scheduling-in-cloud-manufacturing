...
def plot_rmse_curve(train_rmse, val_rmse, save_path=None):
    ...
    plt.title('VND-MAML RMSE Convergence Curve', fontsize=8, pad=5)
    ...
    if save_path:
        ...
        print(f"RMSE convergence figure has been saved. → {save_path}")
    else:
        plt.show()
...
if __name__ == "__main__":
    ...
    if MODEL_PATH.exists():
        ...
        plot_rmse_curve(train_rmse_hist, val_rmse_hist, save_path="vnd_rmse_curve.png")
    else:
